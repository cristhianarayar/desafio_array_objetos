import { arr_propiedades_alquiler } from "./array_propiedades.js";

const container_venta = document.getElementById("SoloAlquilerId")
...
const Page_Alquiler = () =>{
    arr_propiedades_alquiler.forEach((propiedad) => {
